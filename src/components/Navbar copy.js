      ...
      sections: [
        {
          ...
          name: 'Rider',
          items: [
            { name: 'Helmets and goggles', href: '#' },
            { name: 'Jersey and Pants', href: '#' },
            { name: 'Boots', href: '#' },
            { name: 'Gloves', href: '#' },
          ],
        },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex items-center justify-between py-4 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden space-x-10 md:flex">
            ...
            <a href="#" className="text-base font-medium text-gray-500 hover:text-gray-900">Terms</a>
